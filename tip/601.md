...
## New Option
The `encoding` ensamble will be extended by two new options `-nothrow` and `-stoponerror`:
...
*character value* is the hexadecimal representation of the byte in the source string where *error position* points to.
