...
the _foo_ representation from a (_Tcl_Obj_ *) argument. The caller
should then be able to process the extracted _foo_ value in the place
of the *Tcl_Obj* value confident that it represents the original value.
