...
(like "bindir,runtime") information which is not useful in a version string. Also
it would make the version string unusable in `Tcl_InitSubsystems` and friends,
before any Tcl interpreter is created.
