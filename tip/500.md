# TIP 499: Private Methods and Variables in TclOO
...
<dl><dt>**-scope public**</dt>
<dd>Reports the public (public) methods only.</dd>
<dt>**-scope unexported**</dt>
<dd>Reports the unexported (non-public, created via naming or **unexport**)
methods only.</dd>
<dt>**-scope private**</dt>
