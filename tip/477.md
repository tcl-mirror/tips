...
* <a href='#toc-20'>Customizing and extending the build environment</a>
    ...
    * <a href='#toc-27'>Standard targets</a>
        * <a href='#toc-28'>Extending target</a>
    * <a href='#toc-29'>Stubs</a>
    * <a href='#toc-30'>Versioning</a>
    * <a href='#toc-31'>Installation</a>
    * <a href='#toc-32'>Sanity checking build configuration</a>
* <a href='#toc-33'>Reference Implementation</a>
* <a href='#toc-34'>Copyright</a>
...
The two macros that need to be defined are shown below.
...
the `PROJECT_REQUIRES_TK` macro before including `rules-ext.vc`.
...
Note that the **value** of the macro is immaterial (may even be `0`),
it only needs to be defined. All else remains the same as for a Tcl extension.
...
## <a id='toc-27'></a>Standard targets

TBD 

### <a id='toc-28'></a>Extending target
...
## <a id='toc-30'></a>Versioning

TBD - defaults to TEA

TBD - DOTVERSION, VERSION

## <a id='toc-31'></a>Installation

Installation macros

## <a id='toc-32'></a>Sanity checking build configuration

TBD 

# <a id='toc-33'></a>Reference Implementation

The vc-reform branch in the core.tcl.tk repositories contains work-in-progress.



# <a id='toc-34'></a>Copyright
