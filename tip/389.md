...
This also means that functions line "string range" and "string reverse"
might give strange results when characters > **U\+010000** are involved.
The two (internal) UTF-16 surrogates are handled as two separate characters,
which no longer form a valid pair after the operation.
