...
facilities described in it; it describes how to build a property system based
on TclOO that can support making Tk megawidgets.
...
this). Most properties will also be listed in the writable properties of the
class, but initialisation only properties will not. (Note once again:
megawidgets are not **oo:configurable** in the sense of [TIP #558](558.md),
but they do use the same basic TclOO mechanisms.)
