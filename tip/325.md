...
# Systray Interface
 ...
 > **tk systray create** _image_ _text_ _b1\_\callback_ _b3\_\callback_
...
Modifies either the image, string, or callback (Button-1 or Button-3).
...
systray:
    ...
    tk systray create book "Systray sample" {puts "Here is the systray output"} {puts "here is another example"}
